        ...
        if(status=="Done"){
          ...
          if(data.review==" "){
            ...
            star2.onclick = function(){
              ...
              star44.src = "resourse/image/star.png";
              star55.src = "resourse/image/star.png";
              ratingText.innerHTML = "Rating: 2 star";
              console.log(ratingText.innerHTML);
              db.collection("Customer_booking").doc(doc.id).update({
                rating : 2,
              })
            ...
            star3.onclick = function(){
              ...
              star44.src = "resourse/image/star.png";
              star55.src = "resourse/image/star.png";
              ratingText.innerHTML = "Rating: 3 star";
              console.log(ratingText.innerHTML);
              db.collection("Customer_booking").doc(doc.id).update({
                rating : 3,
              })
            ...
            star4.onclick = function(){
              ...
              star55.src = "resourse/image/star.png";
              ratingText.innerHTML = "Rating: 4 star";
              console.log(ratingText.innerHTML);
              db.collection("Customer_booking").doc(doc.id).update({
                rating : 4,
              })
            ...
            star5.onclick = function(){
              ...
              ratingText.innerHTML = "Rating: 5 star";
              console.log(ratingText.innerHTML);
              db.collection("Customer_booking").doc(doc.id).update({
                rating : 5,
              })
          ...
          }else{ //review is written
            var ratingDiv = document.createElement("div");

            var stara = document.createElement("img");
            var starb = document.createElement("img");
            var starc = document.createElement("img");
            var stard = document.createElement("img");
            var stare = document.createElement("img");

            //default rating = 1
            stara.src = "resourse/image/star_fill.png";
            stara.style.width = "20px";
            stara.style.height = "20px";

            starb.src = "resourse/image/star.png";
            starb.style.width = "20px";
            starb.style.height = "20px";

            starc.src = "resourse/image/star.png";
            starc.style.width = "20px";
            starc.style.height = "20px";

            stard.src = "resourse/image/star.png";
            stard.style.width = "20px";
            stard.style.height = "20px";

            stare.src = "resourse/image/star.png";
            stare.style.width = "20px";
            stare.style.height = "20px";

            if(data.rating == 5){
              starb.src = "resourse/image/star_fill.png";
              starc.src = "resourse/image/star_fill.png";
              stard.src = "resourse/image/star_fill.png";
              stare.src = "resourse/image/star_fill.png";
            }
            ...
            ratingDiv.appendChild(stara);
            ratingDiv.appendChild(starb);
            ratingDiv.appendChild(starc);
            ratingDiv.appendChild(stard);
            ratingDiv.appendChild(stare);
